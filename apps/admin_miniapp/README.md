...
Полностью реализованы **Users** (подключена к CRUD API пользователя),
**Newsletter** (подключена к бэкенду `POST /telegram/newsletter`) и **Admin**
(управление администраторами). **Chat** — заглушка «Раздел в разработке».
