"""
Загрузка текстовых шаблонов модуля психолога.

Файл инкапсулирует чтение `messages.json`, чтобы хендлеры и клавиатуры
...
def get_messages() -> dict[str, str]:
    """Читает и кеширует текстовые шаблоны психолога."""
