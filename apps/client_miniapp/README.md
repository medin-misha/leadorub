...
Telegram Mini App для заявки на удаление слитых данных: пользователь указывает
имя, источники утечки и комментарий. Приложение собрано на Vue 3 + Vite и в
production раздаётся внутренним Caddy.
